...
//    public static HashSet<ChessMoves>
    ...
    private HashSet<ChessMove> knightMoves(ChessBoard board, ChessPosition position) {
        ...
        if (inBounds(new ChessPosition(x + 2, y + 1))) {
            if (board.getPiece(new ChessPosition(x + 2, y + 1)) != null && board.getPiece(new ChessPosition(x + 2, y + 1)).getTeamColor() != myColor) {
                myHash.add(new ChessMove(position, new ChessPosition(x + 2, y + 1), null));
            } else if (board.getPiece(new ChessPosition(x + 2, y + 1)) == null) {
                myHash.add(new ChessMove(position, new ChessPosition(x + 2, y + 1), null));
            }
        }
        if (inBounds(new ChessPosition(x + 2, y - 1))) {
        ...
        if (inBounds(new ChessPosition(x + 1, y + 2))) {
            if (board.getPiece(new ChessPosition(x + 1, y + 2)) != null && board.getPiece(new ChessPosition(x + 1, y + 2)).getTeamColor() != myColor) {
                myHash.add(new ChessMove(position, new ChessPosition(x + 1, y + 2), null));
            } else if (board.getPiece(new ChessPosition(x + 1, y + 2)) == null) {
                myHash.add(new ChessMove(position, new ChessPosition(x + 1, y + 2), null));
            }
        }
        if (inBounds(new ChessPosition(x + 1, y - 2))) {
...
//        if (board.getPiece(new ChessPosition(x + 1, y)) == null && board.getPiece(new ChessPosition(x + 2, y)) == null) {
//            if (inBounds(new ChessPosition(x + 2, y - 1))) {
//                if (board.getPiece(new ChessPosition(x + 2, y - 1)) != null && board.getPiece(new ChessPosition(x + 2, y - 1)).getTeamColor() != myColor) {
//                    myHash.add(new ChessMove(position, new ChessPosition(x + 2, y - 1), null));
//                }
...
//            }
//        }
//        if (board.getPiece(new ChessPosition(x, y+ 1)) == null && board.getPiece(new ChessPosition(x, y  + 2)) == null) {
//            if (inBounds(new ChessPosition(x - 1, y + 2))) {
//                if (board.getPiece(new ChessPosition(x - 1, y + 2)) != null && board.getPiece(new ChessPosition(x - 1, y + 2)).getTeamColor() != myColor) {
//                    myHash.add(new ChessMove(position, new ChessPosition(x - 1, y + 2), null));
//                }
